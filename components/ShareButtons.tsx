...
export default function ShareButtons({ title, slug, lang }: ShareButtonsProps) {
  ...
  const btnClass =
    'inline-flex items-center justify-center w-9 h-9 rounded-full border border-gray-300 dark:border-gray-600 hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors cursor-pointer bg-transparent';
