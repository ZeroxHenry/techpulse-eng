...
export const t = {
  en: {
    ...
    aboutP2: "StackPulse started as a tech blog, but I realized something: the internet doesn't need more AI-generated summaries. It needs real people documenting real learning.",
  ...
  ko: {
    ...
    aboutP2: 'StackPulse는 원래 테크 블로그로 시작했지만 깨달았습니다 — 인터넷에 AI가 만든 요약글은 이미 넘쳐납니다. 진짜 필요한 건 실제로 공부하는 사람의 기록입니다.',
