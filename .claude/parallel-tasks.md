...
## Session A: Claude Code — 레이더 블립 콘텐츠 (25개)
...
## Session B: Claude Code — 콘텐츠 파이프라인 리팩토링
...
2. .github/workflows/content-brief.yml 신규 생성:
   ...
   - Claude Code Action (anthropics/claude-code-action@v1) 사용
...
## Session C: Claude Code — 기존 콘텐츠 재구성
